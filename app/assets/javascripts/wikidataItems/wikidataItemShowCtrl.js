angular.module('app').controller('WikidataItemShowCtrl', ['$scope', '$stateParams', 'Thing', 'WikidataItem', 'notifier', function($scope, $stateParams, Thing, WikidataItem, notifier) {
