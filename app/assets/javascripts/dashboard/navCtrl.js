...
angular.module('app').controller('NavCtrl', ['$scope', '$rootScope', '$window', '$interval', '$http', 'AuthToken', 'identity', 'notifier', function($scope, $rootScope, $window, $interval, $http, AuthToken, identity, notifier) {
